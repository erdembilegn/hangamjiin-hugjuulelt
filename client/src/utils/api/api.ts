...
export interface ResponseGetAllUser {
    ...
    /**
     * 
     * @type {Array<ResponseGetAllUserDataInner>}
     * @memberof ResponseGetAllUser
     */
    'data'?: Array<ResponseGetAllUserDataInner>;
}
/**
 * 
 * @export
 * @interface ResponseGetAllUserDataInner
 */
export interface ResponseGetAllUserDataInner {
    /**
     * 
     * @type {string}
     * @memberof ResponseGetAllUserDataInner
     */
    'role': string;
    /**
     * 
